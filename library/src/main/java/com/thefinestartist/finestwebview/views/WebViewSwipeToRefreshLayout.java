 ...
 */
public class WebViewSwipeToRefreshLayout extends SwipeRefreshLayout {

    private static final int SCROLL_BUFFER_DIMEN = 1;
    private static int scrollBuffer;
    private WebView webView;

    public WebViewSwipeToRefreshLayout(Context context) {
        super(context);
    }

    public WebViewSwipeToRefreshLayout(Context context, AttributeSet attrs) {
        super(context, attrs);
    }
